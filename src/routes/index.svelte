                ...
                <div class="webcam-wrapper" transition:fade>
                    ...
                    {#if webcamLoaded}
                        ...
                        {:else if webCamImage}
                            ...
                            {/if}
                        {/if}
                       <div class="webcam-info"> Webcams provided by <a href="https://www.windy.com/" target="_blank">windy.com</a> &mdash; <a
                            href="https://www.windy.com/webcams/add" target="_blank">add a webcam</a>
                       </div>
                    {/if}
                    <div class="actions-buttons-wrap">
                        <Button on:click={() => (showModal = true)} variant="raised">Show Map</Button>
